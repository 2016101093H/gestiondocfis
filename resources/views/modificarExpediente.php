...
<div class="container-fluid">
    ...
    <br>
     <div class="row text-center">
        <div class="col col-lg-1">
            <a href="../vista/mostrarExpedientes.php"><input type="button" class="btn btn-success" value='Gestionar'></a>
        </div>
    ...
    <?php
        ...
        $id = (int)$_GET['id'];
        $db->where ("idexpediente", $id);
        $expediente = $db->getOne ("expediente");
    ?>  
    <div class="row">
        <div class="col col-lg-12">
            <form class="container form-control-sm col-lg-6 breadcrumb" enctype="multipart/form-data" method="POST" action="../controlador/modificarExpediente.php?id=<?php echo $expediente['idexpediente'];?>">
                <div><h4>Datos del Expediente</h4></div><br>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="observacion" value="<?php echo $expediente['observaciones'];?>">
                    </div>
                    <div class="form-group">
                    ...
                    <br>
                <a href="../vista/mostrarExpedientes.php"><input class="btn btn-primary" type=submit value='Actualizar'></a>
            </form>
