    ...
    <br>
     <div class="row text-center">
        <div class="col col-lg-1">
            <a href="../vista/mostrarExpedientesDecano.php"><input type="button" class="btn btn-success" value='Gestionar'></a>
        </div>
    </div>
    <br>
    <?php
        ...
        $id = (int)$_GET['id'];
        $db->where ("iddecano", $id);
        $expediente = $db->getOne ("decano");
    ?>  
    <div class="row">
        <div class="col col-lg-12">
            <form class="container form-control-sm col-lg-6 breadcrumb" enctype="multipart/form-data" method="POST" action="../controlador/modificarExpedienteDecano.php?id=<?php echo $expediente['iddecano'];?>">
