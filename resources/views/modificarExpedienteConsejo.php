    ...
    <br>
     <div class="row text-center">
        <div class="col col-lg-1">
            <a href="../vista/mostrarExpedientesConsejo.php"><input type="button" class="btn btn-success" value='Gestionar'></a>
        </div>
    </div>
    <br>
    <?php
        ...
        $id = (int)$_GET['id'];
        $db->where ("idconsejo", $id);
        $expediente = $db->getOne ("consejo");
    ?>  
    <div class="row">
        <div class="col col-lg-12">
            <form class="container form-control-sm col-lg-6 breadcrumb" enctype="multipart/form-data" method="POST" action="../controlador/modificarExpedienteConsejo.php?id=<?php echo $expediente['idconsejo'];?>">
                <div><h4>Datos del Expediente</h4></div><br>
                    ...
                    <br>
                <a href="../vista/mostrarExpedientesConsejo.php"><input class="btn btn-primary" type=submit value='Actualizar'></a>
            </form>
