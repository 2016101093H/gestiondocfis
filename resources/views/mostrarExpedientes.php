                ...
                <tr>
                    ...
                    <?php foreach ($expedientes as $data) { ?>  
                        <tr>
                            ...
                            <td>
                                <a class='btn btn-danger' href="../controlador/eliminarExpediente.php?id=<?php echo $data['idexpediente'];?>">Eliminar</a><br>
                            </td>
                            <td> 
                                <a class='btn btn-warning' style='color: #fff' href="../vista/modificarExpediente.php?id=<?php echo $data['idexpediente'];?>">Modificar</a>
                            </td>
                            <td> 
                                <a class='btn btn-success' style='color: #fff' href="../vista/detallesExpediente.php?id=<?php echo $data['idexpediente'];?>">Detalles</a>
                            </td>
