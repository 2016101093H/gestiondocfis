...
<div class="container-fluid">
    <div class="row">
			<div class="col-lg-12 text-center" style="background-color: #171a21;">
				<h3 style="color: #fff">Mostrar Alumnos</h3>
			</div>
	</div>
	<br>
	<?php
    ...
    <div class="row text-center">
        <div class="col col-lg-1 col-xs-1">
            <a href="../vista/registrarAlumno.php"><input type="button" class="btn btn-success" value='Registrar'></a>
        </div>
        <div class="col col-lg-1 col-xs-1">    
		    ...
		    <table class="table table-bordered table-inverse table-striped ">
                <tr>
                    ...
                    <?php 
                        ...
                        $db->pageLimit = 5; 
                        $alumnos = $db->arraybuilder()->paginate("alumno", $page);
                        $prev = $page-1;
                        $next = $page+1;
                        if ($db->count == 0) {
                            echo "<td align=center colspan=4>No hay alumnos registrados</td>";
                            return;
                        }
                    ?>
                    <?php foreach ($alumnos as $data) { ?>  
                        <tr>
                            ...
                            <td>
                                <a class='btn btn-danger' href="../controlador/eliminarAlumno.php?id=<?php echo $data['idalumno'];?>">Eliminar</a><br>
                            </td>
                            <td> 
                                <a class='btn btn-warning' style='color: #fff' href="../vista/modificarAlumno.php?id=<?php echo $data['idalumno'];?>">Modificar</a>
                            </td>
                        </tr>
                    <?php } ?>
            </table>
