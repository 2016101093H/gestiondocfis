    ...
    <br>
     <div class="row text-center">
        <div class="col col-lg-1">
            <a href="../vista/mostrarExpedientesAsuntos.php"><input type="button" class="btn btn-success" value='Gestionar'></a>
        </div>
    </div>
    <br>
    <?php
        ...
        $id = (int)$_GET['id'];
        $db->where ("idasuntos", $id);
        $expediente = $db->getOne ("asuntos");
    ?>  
    <div class="row">
        <div class="col col-lg-12">
            <form class="container form-control-sm col-lg-6 breadcrumb" enctype="multipart/form-data" method="POST" action="../controlador/modificarExpedienteAsuntos.php?id=<?php echo $expediente['idasuntos'];?>">
                <div><h4>Datos del Expediente</h4></div><br>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="observaciones" value="<?php echo $expediente['observaciones'];?>">
                    </div>
                    <div class="form-group">
                    ...
                    <br>
                <a href="../vista/mostrarExpedientesAsuntos.php"><input class="btn btn-primary" type=submit value='Actualizar'></a>
            </form>
