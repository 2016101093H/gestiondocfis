            ...
            <table class="table table-bordered table-inverse table-striped">
                <tr>
                    ...
                    <?php 
                        ...
                        $db->pageLimit = 5; 
                        $expedientes = $db->arraybuilder()->paginate("decano", $page);
                        $prev = $page-1;
                        $next = $page+1;
                        if ($db->count == 0) {
                    ...
                    <?php foreach ($expedientes as $data) { ?>  
                        <tr>
                            ...
                            <td> 
                                <a class='btn btn-warning' style='color: #fff' href="../vista/modificarExpedienteDecano.php?id=<?php echo $data['iddecano'];?>">Modificar</a>
                            </td>
